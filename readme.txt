...
These data are not posted in the replication package because the ACS data are too large to be uploaded to GitHub, while I have not been given the permission (or asked) to share the remaining data.
